...
public class AudioManager : MonoSingleton<AudioManager>
{
    ...
    void Awake()
    {
        ...
        {
            { 1, "AudioClip/Music/GamingBGM" },
            { 2, "AudioClip/Music/BattleScene" },
            { 11, "AudioClip/Sound/Drop"},
            { 12, "AudioClip/Sound/Jump"},
            { 13, "AudioClip/Sound/Droping"},
            { 14, "AudioClip/Sound/Die"},
            { 15, "AudioClip/Sound/GetProp"},
            { 16, "AudioClip/Sound/Win"},
            { 17, "AudioClip/Sound/Victory"},
            { 18, "AudioClip/Sound/Sprint"},
            { 19, "AudioClip/Sound/Burning"},
            { 20, "AudioClip/Sound/Lightning"},
        };
